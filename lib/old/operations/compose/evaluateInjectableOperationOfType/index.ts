import {
	...
	type Reify, SbInjectableOperationOfType,
} from "../../../../types"
...
export type EvaluateInjectableOperationOfType = <T extends SbCastableValue>(
	...
	input: Option<Reify<T>>,
) => OperationResult<Reify<T>>

const evaluateInjectableOperationOfType: EvaluateInjectableOperationOfType = op => {
	switch (op.type) {
